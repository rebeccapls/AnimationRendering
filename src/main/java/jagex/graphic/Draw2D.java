...
public class Draw2D {
    ...
    private static final int BACKGROUND = 0x7F555555;

    public Draw2D() {
    }

    public static void prepare(int[] data, int width, int height) {
        dest = data;
        Draw2D.width = width;
    ...
    public static void fillRect(int y, int x, int w, int h, int rgb) {
        if (x < left) {
            w -= left - x;
            x = left;
        }
    ...
    public static void setTransparentBackground(int w, int h) {
        int y = 0, x = 0;
