...
fun animationToGif(images: Array<BufferedImage?>, delays: Array<String?>, name: String, anim: Int): ByteArrayOutputStream {
    val iw = ImageIO.getImageWritersByFormatName("gif").next()
    val stream = ByteArrayOutputStream()
    val directory: File = File("./images/$name")
    !directory.exists().let { directory.mkdir() }
    val ios = FileImageOutputStream(File("./images/$name/$anim.gif"))
    iw.output = ios
