...
class SkeletonService {
    ...
    var frameMaps: Array<SkeletonService?> = arrayOf()
    ...
    fun clearFrames() {
        frameMaps = emptyArray()
    }

    fun init(size: Int) {
        frameMaps = arrayOfNulls(size)
    ...
    fun lookup(index: Int): SkeletonService? {
    ...
    /**
     * Gets the [FrameMap] of this Frame.
     *
